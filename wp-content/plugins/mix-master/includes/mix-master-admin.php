...
if(!class_exists('mix_master_admin_table_header')){
	require_once( dirname( __FILE__ ) . '/mix-master-admin-table-header.php');
}
...
if(!class_exists('mix_master_admin_table_news')){
	require_once( dirname( __FILE__ ) . '/mix-master-admin-table-news.php');
}
//Prepare Table of elements
...
<?php
if(!class_exists('mix_master_admin_table_support')){
	require_once( dirname( __FILE__ ) . '/mix-master-admin-table-support.php');
}
//Prepare Table of elements
$wp_list_table = new mix_master_admin_table_support();
//Table of elements
$wp_list_table->display();
