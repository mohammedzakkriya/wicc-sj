<tr>
    ...
    <td>
        <p>
            ...
            <p class="description">
                <?php echo esc_html__( 'Your Private URL will be: ', 'prevent-direct-access-lite' ) ?><?php echo get_site_url() . '/' ?><span id="pda_prefix"><?php echo esc_html__( 'private', 'prevent-direct-access-lite' ) ?></span>/<?php _e( 'your-custom-filename', 'prevent-direct-access-lite' ) ?></p>
