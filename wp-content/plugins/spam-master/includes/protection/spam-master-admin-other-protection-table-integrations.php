...
if(is_multisite()){
	...
	if (isset($_POST['spam_master_amp_check_fun'])){
	update_blog_option($blog_id, 'spam_master_amp_check_fun', $_POST['spam_master_amp_check_fun'] );
	}
	else{
	update_blog_option($blog_id, 'spam_master_amp_check_fun', 'false' );
	}
	...
	if (isset($_POST['spam_master_amp_check_fun'])){
	update_option('spam_master_amp_check_fun', $_POST['spam_master_amp_check_fun'] );
	}
	else{
	update_option('spam_master_amp_check_fun', 'false' );
	}
	if (isset($_POST['spam_master_recaptcha_ampoff'])){
...
//Get option settings to be used in populate online / offline table
if(is_multisite()){
...
//Populate online / offilne table status
...
if($spam_master_amp_check_fun == 'true'){
	$spam_master_amp_check_fun_status = '<td style="vertical-align:middle; width:70%;" bgcolor="#07B357"><font color="white"><b>ONLINE - Using AMP function</b></font></td>';
	$spam_master_amp_check_fun_text = ' - AMP function is On';
}
else{
	$spam_master_amp_check_fun_status = '<td style="vertical-align:middle; width:70%;" bgcolor="#563a3a"><font color="white"><b>OFFLINE - Not using AMP function</b></font></td>';
	$spam_master_amp_check_fun_text = false;
}
if($spam_master_recaptcha_ampoff == 'true'){
	if($spam_master_amp_check_fun == 'true'){
		$spam_master_recaptcha_ampoff_status = '<td style="vertical-align:middle; width:70%;" bgcolor="#07B357"><font color="white"><b>ONLINE - Using AMP Switch</b></font></td>';
		$spam_master_recaptcha_ampoff_text = ' - AMP Switch is ON';
	}
	else{
		$spam_master_recaptcha_ampoff_status = '<td style="vertical-align:middle; width:70%;" bgcolor="#563a3a"><font color="white"><b>OFFLINE - Warning!!! AMP function is Off - AMP Switch is ON</b></font></td>';
		$spam_master_recaptcha_ampoff_text = ' - Warning!!! AMP function is Off - AMP Switch is ON';
	}
}
else{
	if($spam_master_amp_check_fun == 'true'){
		$spam_master_recaptcha_ampoff_status = '<td style="vertical-align:middle; width:70%;" bgcolor="#563a3a"><font color="white"><b>OFFLINE - AMP function is On - Warning!!! AMP Switch is Off</b></font></td>';
		$spam_master_recaptcha_ampoff_text = ' - Warning!!! AMP Switch is Off';
	}
	else{
		$spam_master_recaptcha_ampoff_status = '<td style="vertical-align:middle; width:70%;" bgcolor="#563a3a"><font color="white"><b>OFFLINE - Not using AMP function</b></font></td>';
		$spam_master_recaptcha_ampoff_text = false;
	}
}
if($spam_master_recaptcha_preview == 'true'){
	$spam_master_recaptcha_preview_status = '<td style="vertical-align:middle; width:70%;" bgcolor="#07B357"><font color="white"><b>ONLINE'.$spam_master_amp_check_fun_text.$spam_master_recaptcha_ampoff_text.'</b></font></td>';
}
else{
	$spam_master_recaptcha_preview_status = '<td style="vertical-align:middle; width:70%;" bgcolor="#563a3a"><font color="white"><b>OFFLINE</b></font></td>';
}
...
<p>If you are a plugin developer and want your plugin included in Spam Master API, get in touch with us via support ticket.</p>
		...
		<tr class="alternate">
			<th colspan="2">
				...
				<p>Re-Captcha works on Accelerated Mobile Pages (AMP), but does not conform to the <a href="https://www.ampproject.org/docs/reference/components" target="_blank"> strict AMP standard definitions</a>. It is therefore recommended to Activate AMP check and Switch it off for AMP pages.</p>
			</th>
		</tr>
		<tr class="alternate">
			<td>
		...
		<tr class="alternate">
			<td>
				<input name="spam_master_amp_check_fun" id="spam_master_amp_check_fun" value="true" type="checkbox" <?php if(is_multisite()){echo get_blog_option($blog_id, 'spam_master_amp_check_fun') == 'true' ? 'checked="checked"':'';}else{echo get_option('spam_master_amp_check_fun') == 'true' ? 'checked="checked"':'';} ?> />
				<label for="spam_master_amp_check_fun"><b><?php _e('Activate AMP Check', 'spam_master'); ?></b></label>
			</td>
			<?php echo $spam_master_amp_check_fun_status; ?>
		</tr>
		<tr class="alternate">
			<td>
			...
			<?php echo $spam_master_recaptcha_ampoff_status; ?>
		</tr>
		<tr class="alternate">
			<td>
			...
			<?php echo $spam_master_recaptcha_preview_status; ?>
		</tr>
		<tr class="alternate">
			<th colspan="2">
<?php
...
if ( !('true' == spam_master_amp_check() && !( 'true' == $spam_master_recaptcha_ampoff ) ) ) {
	...
	echo '<div id="message" class="info"><p>Re-Captcha Activated in AMP MODE".</p></div>';
}		
?>		
			</th>
		</tr>
