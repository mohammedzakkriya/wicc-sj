...
if($response_key == 'VALID' || $response_key == 'MALFUNCTION_1' || $response_key == 'MALFUNCTION_2'){
	...
	if ($spam_master_alert_level == 'ALERT_3'){
		...
		$spam_master_alert_3 = get_comments( $args );
		foreach ($spam_master_alert_3 as $spam_master_alert_3_comment){
			
			$spam_master_last_comment_date = $spam_master_alert_3_comment->comment_date;
			
			$flood_date_plus_2 = date('Y-m-d H:i:s', strtotime($spam_master_last_comment_date . '+ 2 minute'));
