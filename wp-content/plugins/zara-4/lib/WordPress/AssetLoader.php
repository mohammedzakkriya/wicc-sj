...
if ( ! class_exists( 'Zara4_WordPress_AssetLoader' ) ) {
  ...
  class Zara4_WordPress_AssetLoader {
    ...
    private static function enqueue_media_assets() {
      ...
      /** @noinspection PhpUndefinedFunctionInspection */
      wp_enqueue_script( 'media-page', ZARA4_PLUGIN_BASE_URL.'/js/media-page.min.js', array( 'jquery' ), ZARA4_VERSION );
      /** @noinspection PhpUndefinedFunctionInspection */
      wp_enqueue_script( 'media-page-loader', ZARA4_PLUGIN_BASE_URL.'/js/media-page.js', array( 'jquery' ), ZARA4_VERSION );
      /** @noinspection PhpUndefinedFunctionInspection */
      ...
      //
      /** @noinspection PhpUndefinedFunctionInspection */
      wp_enqueue_script( 'bootstrap-js', ZARA4_PLUGIN_BASE_URL.'/packages/bootstrap/3.3.7/js/bootstrap.min.js', array( 'jquery' ), ZARA4_VERSION );

      //
      // Sortable tables
      //
      /** @noinspection PhpUndefinedFunctionInspection */
      wp_enqueue_script( 'tablesorter', ZARA4_PLUGIN_BASE_URL.'/packages/tablesorter/jquery.tablesorter.min.js', array( 'jquery' ), ZARA4_VERSION );

      //
      // Modal
      //
      /** @noinspection PhpUndefinedFunctionInspection */
      wp_enqueue_script( 'modal-js', ZARA4_PLUGIN_BASE_URL.'/packages/jquery-modal/v0.7.0/modal.min.js', array( 'jquery' ), ZARA4_VERSION );
      /** @noinspection PhpUndefinedFunctionInspection */
      wp_enqueue_style( 'modal-css', ZARA4_PLUGIN_BASE_URL.'/packages/jquery-modal/v0.7.0/modal.css', array(), ZARA4_VERSION );
    }
    ...
    private static function enqueue_settings_assets() {
      /** @noinspection PhpUndefinedFunctionInspection */
      wp_enqueue_script( 'settings-page', ZARA4_PLUGIN_BASE_URL.'/js/settings-page.min.js', array( 'jquery' ), ZARA4_VERSION );
      /** @noinspection PhpUndefinedFunctionInspection */
      wp_localize_script( 'settings-page', 'Z4_BASE_URL', ZARA4_DEV ? 'http://zara4.dev' : 'https://zara4.com' );

      /** @noinspection PhpUndefinedFunctionInspection */
      wp_enqueue_script( 'settings-page-settings', ZARA4_PLUGIN_BASE_URL.'/js/settings-page.js', array( 'jquery' ), ZARA4_VERSION );

      /** @noinspection PhpUndefinedFunctionInspection */
      wp_enqueue_style( 'font-awesome', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', array(), ZARA4_VERSION );
