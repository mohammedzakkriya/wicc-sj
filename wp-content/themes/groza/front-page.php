...
<?php if( 'page' == get_option( 'show_on_front' ) ): ?>
	...
	<?php 
		...
		}elseif( 'three' == get_theme_mod( 'business_page_layout_type' ) ){
			get_template_part( 'template-parts/front-three' );
		}elseif( 'four' == get_theme_mod( 'business_page_layout_type' ) ){
			get_template_part( 'template-parts/front-four' );			
		}else{
